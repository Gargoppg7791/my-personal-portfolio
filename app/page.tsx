...
>>>>>>> a26a6e336dc8e5d8e51e8d415dec8270d1f0dade
  ...
  const projects = [
    ...
    {
      title: 'PDF Annotator - Full Stack',
      description: 'Professional document annotation tool with powerful highlighting features. Upload, annotate, and manage PDF documents with automatic saving and session syncing across users.',
      image: '/Screenshot 2025-09-16 112813 copy copy.png',
      tech: ['React', 'Node.js', 'Express', 'MongoDB', 'JWT Auth', 'PDF.js', 'UUID'],
      github: 'https://github.com/Gargoppg7791/Pdf-annoator-full-stack',
      live: 'https://pdf-annoator-full-stack.vercel.app/'
    },
    {
...
<<<<<<< HEAD
      ...
      achievements: [
        ...
        'it was an accurate and scalable project'
      ]
    },
    {
      title: 'work As a Volunteer',
      company: 'Google Developer Group, Udaipur',
      period: '2025 - 2025',
      description: ' Organized a tech event popularly known as DEVFEST by Google as a volunteer featuring speakers from diverse backgrounds in the tech industry sharing their knowledge and experiences in front of 300+ audience.',
      achievements: [
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-96 h-96 mx-auto">
              ...
              <Avatar className="w-88 h-88 absolute inset-4 border-4 border-white dark:border-gray-800 shadow-2xl">
